    ...
    <main class="text-center d-flex justify-content-center mt-3" style="color:black;">
        <div class="w-75">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-column text-start p-2 w-100">
                            ...
                            <div class="d-flex justify-content-around mt-5">
                                <a href="<?php echo e(asset('storage/files/'.$material->material_link)); ?>"><button class="btn btn-primary" style="width:100px">Materi</button></a>
            ...
            <a href="/learning-materials-detail/0" >
                <button class="w-100 btn btn-success mb-3 mt-1">Tambah Bahan Ajar</button>
            </a>
            <?php endif; ?>
        </div>
    </main>
...
<?php echo $__env->make('Base.Navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass - Copy\resources\views/LearningMaterials.blade.php ENDPATH**/ ?>