...
<div class="w-100 d-flex flex-column p-1" style="color:#FFF5E0;">
    <div class="d-flex flex-row" style="background-color:#FAF0D7">
        <img src="<?php echo e(asset('images/assets/logo.png')); ?>" class="img-responsive" style="height:15vh; width:7vw;" alt="">
...
<?php echo $__env->make('Base.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass - Copy\resources\views/Base/Navbar.blade.php ENDPATH**/ ?>