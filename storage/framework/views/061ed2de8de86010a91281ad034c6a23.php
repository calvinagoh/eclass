...
<div class="w-100 d-flex flex-column p-1">
    <div class="d-flex flex-row">
        <img src="<?php echo e(asset('images/assets/logo.png')); ?>" class="img-responsive" style="height:10vh; width:7vw;" alt="">
...
<?php echo $__env->make('Base.Master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\WEB PROGRAMMING\huawenzhenhao\resources\views/Base/Navbar.blade.php ENDPATH**/ ?>