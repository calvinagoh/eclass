...
<?php $__env->startSection('body'); ?>
    <main class="form-signin d-flex align-items-center justify-content-center">
        <div class="border-secondary w-75 d-flex justify-content-center border border-5 rounded p-3 " style="color:black;">
...
<?php echo $__env->make('Base.Navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass - Copy\resources\views/UploadClassAssignment.blade.php ENDPATH**/ ?>