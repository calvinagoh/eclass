...
<main class="form-signin d-flex align-items-center justify-content-center" style="height:100vh">
    <div class="w-75 d-flex justify-content-center border border-secondary border-5 rounded p-3">
        <?php if($forum != null): ?>
            <form action="/edit-forum/<?php echo e($forum->forum_id); ?>" method="POST" class="w-100 d-flex flex-column" enctype="multipart/form-data" style="color:black;">
                <?php echo csrf_field(); ?>
                <label class="mb-3 mt-1 text-center" style="font-size:40px">Edit Forum</label>
        ...
        <?php else: ?>
            <form action="/save-new-forum" method="POST" class="w-100 d-flex flex-column" enctype="multipart/form-data" style="color:black;">
                <?php echo csrf_field(); ?>
                <label class="mb-3 mt-1 text-center" style="font-size:40px">Forum Diskusi</label>
                <div class="w-100 d-flex justify-content-center">
                    <div class="w-100 d-flex flex-column">
                        <div class="w-100 d-flex flex-row">
                            <div class="w-50 d-flex flex-column p-3">
...
<?php echo $__env->make('Base.Navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass\resources\views/EditForum.blade.php ENDPATH**/ ?>