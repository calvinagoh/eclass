...
<main class="form-signin d-flex align-items-center justify-content-center" style="height:100vh">
    <div class="w-75 d-flex justify-content-center border border-secondary border-5 rounded p-3" style="color:black">
        <?php if($forum != null): ?>
            <form action="/edit-forum/<?php echo e($forum->forum_id); ?>" method="POST" class="w-100 d-flex flex-column" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <label class="mb-3 mt-1 text-center" style="font-size:40px">Edit Forum Diskusi</label>
        ...
        <?php else: ?>
            <form action="/save-new-forum" method="POST" class="w-100 d-flex flex-column" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <label class="mb-3 mt-1 text-center" style="font-size:40px">Tambah Forum Diskusi</label>
                <div class="w-100 d-flex justify-content-center">
                    <div class="w-100 d-flex flex-column">
                        <div class="w-100 d-flex flex-row">
                            <div class="w-50 d-flex flex-column p-3">
                                <div class="form-group mb-2">
                                    <label>Judul</label>
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Judul" <?php if($forum != null): ?> value="<?php echo e($forum->title); ?>" <?php endif; ?>>
                                </div>
                                <div class="form-group mb-2">
                                    <label>Deskripsi</label>
                            ...
                            <div class="w-50 d-flex flex-column p-3">
                                <div class="form-group mb-2">
                                    <label>Kode Kelas</label>
                                    <input type="text" class="form-control" id="classCode" name="classCode" placeholder="Kode Kelas" <?php if($forum != null): ?> value="<?php echo e($forum->class_code); ?>" <?php endif; ?>>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('Base.Navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eclass - Copy\resources\views/EditForum.blade.php ENDPATH**/ ?>