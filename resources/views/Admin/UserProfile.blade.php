                            ...
                            <div class="w-100 d-flex flex-row">
                                <div class="w-50 d-flex flex-column p-3">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="fullName" name="fullName" placeholder="Nama Lengkap" value="{{$user->full_name}}">
                                    </div>
                                    <div class="form-group mb-2">
                                ...
                                <div class="w-50 d-flex flex-column p-3">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="classCode" name="classCode" placeholder="Kode Kelas" value="{{$user->class_code}}">
                                    </div>
                                </div>
                            </div>
